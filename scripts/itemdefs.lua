...
local tool_templates = {
    augment_luna4s_cloak = util.extend(commondefs.augment_template) {
        ...
        profile_icon_100 = "gui/icons/item_icons/icon-item_luna4s_inviscloak.png",
    },
    item_luna4s_silencegrenade = util.extend(commondefs.item_template) {
        ...
        profile_icon = "gui/icons/item_icons/items_icon_small/icon-item_luna4s_bubble_small.png",
        profile_icon_100 = "gui/icons/item_icons/icon-item_luna4s_bubble.png",
